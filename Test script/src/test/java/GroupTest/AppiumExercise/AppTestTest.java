package GroupTest.AppiumExercise;
...
public class AppTestTest {
    ...
    public void setUp() throws MalformedURLException {
        ...
        capabilities.setCapability("platformversion", "4.4.2"); // 8.1.0 phiên bản Android của thiết bị
       ...
       capabilities.setCapability("app", "D:/Appium/app-debug.apk"); 
